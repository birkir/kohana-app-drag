...
},drb:function(){var a="".split("").reverse().join("");
...
var g=AmCharts.text(this.container,2,2,"".split("").reverse().join(""),{fill:"#ffffff","font-family":"Verdana","font-size":1,"text-anchor":"start"});
g.translate(5+","+8);
